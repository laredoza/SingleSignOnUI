...
export class RoleListComponent implements OnInit {
  ...
  dataSource: DataSourceResponse<Role[]>;
  ...
  constructor(
    ...
    this.dataSource = new DataSourceResponse<Role[]>();
    this.dataSource.data = new Array<Role>();
  ...
  async loadData(all: boolean): Promise<DataSourceResponse<Role[]>> {
    this.isLoadingResults = true;
    ...
    try {
      ...
      const result = await this.service
        .returnRoles(this.dataSourceRequest)
        .toPromise();
      ...
      this.messageService.displayMessage("Failed loading roles");
