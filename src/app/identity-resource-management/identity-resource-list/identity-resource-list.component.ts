...
export class IdentityResourceListComponent implements OnInit {
  ...
  dataSource: DataSourceResponse<IdentityResource[]>;
  ...
  constructor(
    ...
    this.dataSource = new DataSourceResponse<IdentityResource[]>();
    this.dataSource.data = new Array<IdentityResource>();
  ...
  async loadData(all: boolean): Promise<DataSourceResponse<IdentityResource[]>> {
    ...
    try {
      ...
      const result = await this.service
        .returnIdentityResources(this.dataSourceRequest)
        .toPromise();
